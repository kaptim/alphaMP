...
from grit.finetuning import (
    ...
    init_model_from_pretrained_exact,
)

from grit.finetuning import load_pretrained_model_cfg, init_model_from_pretrained
...
if __name__ == "__main__":
    ...
    x = 1
    args = parse_args()
    # Setup of the config file (set default values for parameters not set in .yaml)
    set_cfg(cfg)
    ...
    for run_id, seed, split_index in zip(*run_loop_settings()):
        ...
        elif cfg.pretrained_exact.model_dir:
            model = init_model_from_pretrained_exact(
                model, cfg.pretrained_exact.model_dir
            )
